...
src_color, src_depth = sync_frames[0]
tgt_color, tgt_depth = sync_frames[1]
...
print("inv(icp_result.transformation):\n", np.linalg.inv(icp_result.transformation))
